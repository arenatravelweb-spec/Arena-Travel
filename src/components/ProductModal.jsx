...
const DEST_INFO = {
  ...
  'santa cruz de la sierra': 'Santa Cruz de la Sierra es la ciudad más grande y dinámica de Bolivia, ubicada en las llanuras del oriente. Con un clima cálido, una gastronomía criolla deliciosa y una vida nocturna vibrante, es la puerta de entrada a las Misiones Jesuíticas declaradas Patrimonio de la Humanidad, la selva amazónica y el Parque Nacional Amboró.',
  'sur argentino':  'El Sur Argentino es una de las regiones más impresionantes del planeta. Desde los lagos cristalinos y montañas nevadas de la Patagonia andina hasta los glaciares eternos de El Calafate, los pingüinos de Puerto Madryn y el Fin del Mundo en Ushuaia, cada rincón ofrece paisajes que quitan el aliento y aventuras únicas.',
