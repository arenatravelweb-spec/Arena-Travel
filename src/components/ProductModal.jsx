...
const DEST_INFO = {
  ...
  'búzios':            'Búzios es la Saint-Tropez brasileña: un pueblo de pescadores convertido en el balneario más glamoroso de Río de Janeiro, con más de 20 playas de aguas cristalinas, calles de piedra y una vida nocturna sofisticada frente al mar.',
  'buzios':            'Búzios es la Saint-Tropez brasileña: un pueblo de pescadores convertido en el balneario más glamoroso de Río de Janeiro, con más de 20 playas de aguas cristalinas, calles de piedra y una vida nocturna sofisticada frente al mar.',
  'barra de tijuca':   'Barra da Tijuca es el balneario más moderno de Río de Janeiro: una playa de casi 20 km, shoppings de primer nivel y la infraestructura heredada de los Juegos Olímpicos 2016, ideal para combinar playa, deporte y vida urbana carioca.',
  'cabo frío':         'Cabo Frío, en la Región de los Lagos de Río de Janeiro, es famoso por sus dunas blancas que recuerdan al Sahara, sus aguas cristalinas y la Playa del Forte, cuna del histórico Fuerte São Mateus.',
  'cabo frio':         'Cabo Frío, en la Región de los Lagos de Río de Janeiro, es famoso por sus dunas blancas que recuerdan al Sahara, sus aguas cristalinas y la Playa del Forte, cuna del histórico Fuerte São Mateus.',
