-- Patagonia Soñada, Villa Carlos Paz, Mendoza

INSERT INTO productos (
  nombre, categoria, descripcion,
  destino_ciudad, origen_ciudad,
...
(
  'Patagonia Soñada',
  'nacional',
  'Un recorrido épico por la Patagonia Argentina: Puerto Madryn, Ushuaia, El Calafate, Perito Moreno y Bariloche. 18 días de aventura, glaciares, ballenas y paisajes que quitan el aliento.',
  'Patagonia Argentina',
  ...
  '[
    ...
    {"dia":6,"titulo":"Río Gallegos — Ushuaia","descripcion":"Luego del desayuno partimos hacia la frontera con Chile. Cruce del Estrecho de Magallanes en ferri, atravesando San Sebastián, Río Grande y Tolhuin hasta Ushuaia.","actividades":["Trámites migratorios en la frontera con Chile","Cruce en ferri por el Estrecho de Magallanes"]},
    ...
    {"dia":13,"titulo":"El Calafate — Perito Moreno","descripcion":"Luego del desayuno viaje por la mítica Ruta Nacional N° 40 hacia la localidad de Perito Moreno. Arribo a la tardecita.","actividades":[]},
...
(
  'Villa Carlos Paz',
  'nacional',
  'Conocé las sierras cordobesas en Carlos Paz con pensión completa. 4 días junto al Lago San Roque, Cumbrecita y Villa General Belgrano.',
  'Villa Carlos Paz',
  'San Miguel de Tucumán',
  4, 3,
  0,
  ...
  '["Bus 5* Mix","3 noches de alojamiento en Villa Carlos Paz","Pensión Completa (desayuno, almuerzo y cena)","Coordinación permanente","Asistencia Médica"]'::jsonb,
  '["Excursiones opcionales","Comidas en ruta","Propinas"]'::jsonb
),
...
(
  'Mendoza',
  'nacional',
  'La capital del vino argentino te espera con City Tour incluido, bodegas, chocolates y la majestuosa Cordillera de los Andes. 6 días / 3 noches de alojamiento.',
  'Mendoza',
  'San Miguel de Tucumán',
  6, 3,
  0,
  '[
    ...
    {"dia":2,"titulo":"Mendoza","descripcion":"Llegada en horas de la mañana. City Tour incluido por la Ciudad Vieja y Ciudad Nueva, zona vitivinícola y fábrica de chocolates.","actividades":["City Tour incluido: Ciudad Vieja (fundada en 1561), Ciudad Nueva, Barrio Cívico, Palacio de Justicia","Visita guiada a una bodega — degustación","Visita a fábrica de alfajores y chocolates","Cerro de la Gloria en Parque San Martín (opcional)"]},
  ...
  '["Bus 5*","3 noches de alojamiento en Mendoza","Media Pensión (desayuno y cena)","City Tour incluido por la ciudad","Visita guiada a una bodega","Coordinación permanente","Asistencia al viajero"]'::jsonb,
  '["Entradas o impuestos","Excursiones opcionales","Bebidas en las comidas","Propinas"]'::jsonb
);
