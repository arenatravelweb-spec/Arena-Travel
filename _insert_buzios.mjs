...
const buzios = {
  ...
  incluye: [
    ...
    '7 noches de alojamiento en Búzios — Pousada Kybalion o similar',
...
const { data, error } = await supabase.from('productos').insert(buzios).select().single()

if (error) {
  console.error('Error:', error.message)
  process.exit(1)
}
console.log('✅ Búzios 2027 insertado con ID:', data.id)
